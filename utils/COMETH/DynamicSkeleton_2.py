...
class DynamicSkeleton(ConstrainedSkeleton):
    def __init__(self, config=current_path+'BODY15_constrained_3D.xml', name=None, osim_file=None, geometry_dir='', max_velocity=None):
        ...
        self.q_l[20], self.q_u[20] = -10, 10    # lumbar_bending
        self.q_l[21], self.q_u[21] = -10, 30      # lumbar_extension
        self.q_l[22], self.q_u[22] = -10, 10      # lumbar_twist
        self.q_l[23], self.q_u[23] = -20, 20    # thorax_bending
        self.q_l[24], self.q_u[24] = -20, 20      # thorax_extension
        self.q_l[25], self.q_u[25] = -10, 10      # thorax_twist
        ...
        self.q_l[35], self.q_u[35] = -10, 170    # elbow_r_flexion       -6, 154
        self.q_l[36:38], self.q_u[36:38] = -90, 90   # wrist
        ...
        self.q_l[45], self.q_u[45] = -10, 170    # elbow_l_flexion       -6, 154
        self.q_l[46:48], self.q_u[46:48] = -90, 90   # wrist
